        ...
        <div className="flex flex-1 justify-center items-center gap-2 px-18 relative ">
          ...
          <AnimatePresence>
            {isFocused && (
              <motion.div 
                ...
                className="relative sm:hidden right-45"
              >
                <Phonegenre />
              </motion.div>
            )}
          ...
          <div 
            className={`relative flex items-center bg-gray-100 dark:bg-gray-800 rounded-full transition-all duration-500 border-2 ${
              isFocused 
                ? "w-50 max-w-150 relative right-75 sm:right-0 border-indigo-500 ring-4 ring-indigo-500/10 shadow-lg" 
          ...
          <div className="relative top-20 absolute right-70">
